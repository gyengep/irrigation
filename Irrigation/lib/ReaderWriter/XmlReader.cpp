...
XmlReader::XmlReader() : doc(new xml_document()) {
}

XmlReader::~XmlReader() {
}

void XmlReader::loadFromString(const std::string& text) {
...
void XmlReader::load(DocumentDTO& document) const {
...
void XmlReader::load(ProgramDTO& program) const {
...
void XmlReader::load(RunTimeDTO& runTime) const {
...
void XmlReader::load(StartTimeDTO& startTime) const {
...
void XmlReader::load(SpecifiedSchedulerDTO& scheduler) const {
