...
const duration<int64_t> Configuration::defaultTemperatureForecastUpdatePeriod = minutes(1);
const duration<int64_t> Configuration::defaultTemperatureCacheLength = hours(24);
const duration<int64_t> Configuration::defaultTemperatureHistoryPeriod = minutes(1);
