...
TEST_F(RestViewTest, acceptableXml1) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));

	Response response = executeRequest("GET", createProgramUrl(programId), "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng;q=0.8,application/signed-exchange;v=b3");
	EXPECT_THAT(response.responseCode, Eq(200));
}

TEST_F(RestViewTest, acceptableXml2) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));
...
TEST_F(RestViewTest, acceptableXml3) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));
...
TEST_F(RestViewTest, acceptableXml4) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));

	Response response = executeRequest("GET", createProgramUrl(programId), "Accept: application/xml,text/html,application/xhtml+xml;q=0.9,image/webp,image/apng;q=0.8,application/signed-exchange;v=b3");
	EXPECT_THAT(response.responseCode, Eq(200));
}

TEST_F(RestViewTest, acceptableXml5) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));
...
TEST_F(RestViewTest, acceptableXml6) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));
...
TEST_F(RestViewTest, acceptableXml7) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));

	Response response = executeRequest("GET", createProgramUrl(programId), "Accept: text/html,application/xhtml+xml;q=0.9,image/webp,image/apng;q=0.8,application/signed-exchange;application/xml");
	EXPECT_THAT(response.responseCode, Eq(200));
}

TEST_F(RestViewTest, acceptableXml8) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));
...
TEST_F(RestViewTest, acceptableXml9) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));
...
TEST_F(RestViewTest, acceptableEverithing1) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));

	Response response = executeRequest("GET", createProgramUrl(programId), "Accept: text/html,application/xhtml+xml,*/*;q=0.9,image/webp,image/apng;q=0.8,application/signed-exchange;v=b3");
	EXPECT_THAT(response.responseCode, Eq(200));
}

TEST_F(RestViewTest, acceptableEverithing2) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));
...
TEST_F(RestViewTest, acceptableEverithing3) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));
...
TEST_F(RestViewTest, acceptableEverithing4) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));
...
TEST_F(RestViewTest, acceptableEverithing5) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));
...
TEST_F(RestViewTest, acceptableEverithing6) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));
...
TEST_F(RestViewTest, acceptableEverithing7) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));

	Response response = executeRequest("GET", createProgramUrl(programId), "Accept: text/html,application/xhtml+xml;q=0.9,image/webp,image/apng;q=0.8,application/signed-exchange;*/*");
	EXPECT_THAT(response.responseCode, Eq(200));
}

TEST_F(RestViewTest, acceptableEverithing8) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));
...
TEST_F(RestViewTest, acceptableEverithing9) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));
...
TEST_F(RestViewTest, notAcceptable) {
	const IdType programId;
	document->getPrograms().insert(programId, shared_ptr<Program>(new Program()));

	Response response = executeRequest("GET", createProgramUrl(programId), "Accept: text/html ,application/xhtml+xml ;q=0.9 ,image/webp ,image/apng ;q=0.8 ,application/signed-exchange ");
	EXPECT_THAT(response.responseCode, Eq(406));
}
