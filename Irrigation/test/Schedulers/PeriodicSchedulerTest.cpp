...
TEST(PeriodicSchedulerTest, process) {
	...
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 5)), Scheduler::Result(true, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 6)), Scheduler::Result(false, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 7)), Scheduler::Result(true, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 8)), Scheduler::Result(true, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 9)), Scheduler::Result(false, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 10)), Scheduler::Result(false, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 11)), Scheduler::Result(false, false, 0));

	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 12)), Scheduler::Result(true, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 13)), Scheduler::Result(false, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 14)), Scheduler::Result(true, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 15)), Scheduler::Result(true, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 16)), Scheduler::Result(false, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 17)), Scheduler::Result(false, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 18)), Scheduler::Result(false, false, 0));

	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 19)), Scheduler::Result(true, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 20)), Scheduler::Result(false, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 21)), Scheduler::Result(true, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 22)), Scheduler::Result(true, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 23)), Scheduler::Result(false, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 24)), Scheduler::Result(false, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 25)), Scheduler::Result(false, false, 0));

	///////////////////////////////////////////////////////////////////////////

	EXPECT_THAT(scheduler.process(fromLocalTime(2017, 11, 13)), Scheduler::Result(true, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2017, 11, 14)), Scheduler::Result(false, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2017, 11, 15)), Scheduler::Result(true, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2017, 11, 16)), Scheduler::Result(true, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2017, 11, 17)), Scheduler::Result(false, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2017, 11, 18)), Scheduler::Result(false, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2017, 11, 19)), Scheduler::Result(false, false, 0));

	///////////////////////////////////////////////////////////////////////////

	EXPECT_THAT(scheduler.process(fromLocalTime(2016, 11, 14)), Scheduler::Result(true, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2016, 11, 15)), Scheduler::Result(false, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2016, 11, 16)), Scheduler::Result(true, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2016, 11, 17)), Scheduler::Result(true, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2016, 11, 18)), Scheduler::Result(false, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2016, 11, 19)), Scheduler::Result(false, false, 0));
	EXPECT_THAT(scheduler.process(fromLocalTime(2016, 11, 20)), Scheduler::Result(false, false, 0));
}
...
TEST(PeriodicSchedulerTest, processInvalid) {
	...
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 5)), Scheduler::Result(false, false, 0));
}
