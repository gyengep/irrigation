...
TEST_F(TemperatureDependentSchedulerImplProcessTest, process) {
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 1, 4, 0, 0)), Pointee(Scheduler::Result(85u)));	// 85 : 90
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(85));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 2, 4, 0, 0)), Pointee(Scheduler::Result(70u)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 3, 4, 0, 0)), Pointee(Scheduler::Result(105u)));	// 95 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(95));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 4, 4, 0, 0)), Pointee(Scheduler::Result(75u)));	// 60 : 50
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(60));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 5, 4, 0, 0)), Pointee(Scheduler::Result(55u)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 6, 4, 0, 0)), Pointee(Scheduler::Result(0u)));	// 0 : 0
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(20));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 7, 4, 0, 0)), Pointee(Scheduler::Result(50u)));	// 70 : 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(70));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 8, 4, 0, 0)), Pointee(Scheduler::Result(80u)));	//	80
...
TEST_F(TemperatureDependentSchedulerImplProcessTest, minAdjustment70) {
	...
	// remaining: 60 - 50 = 10
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 5, 4, 0, 0)), Pointee(Scheduler::Result(70u)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(80));
	...
	// remaining: 35 - 0 = 35
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 7, 4, 0, 0)), Pointee(Scheduler::Result(70u)));	// 70 : 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(105));

	// remaining: 105 - 70 = 35
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 8, 4, 0, 0)), Pointee(Scheduler::Result(70u)));	//	80
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(105));
}
...
TEST_F(TemperatureDependentSchedulerImplProcessTest, minAdjustment100) {
	...
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 1, 4, 0, 0)), Pointee(Scheduler::Result(100u)));	// 85 : 90
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 2, 4, 0, 0)), Pointee(Scheduler::Result(100u)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(110));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 3, 4, 0, 0)), Pointee(Scheduler::Result(100u))); 	// 95 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(135));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 4, 4, 0, 0)), Pointee(Scheduler::Result(100u)));	// 60 : 50
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(125));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 5, 4, 0, 0)), Pointee(Scheduler::Result(0u)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(75));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 6, 4, 0, 0)), Pointee(Scheduler::Result(0u)));	// 0 : 0
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(30));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 7, 4, 0, 0)), Pointee(Scheduler::Result(100u)));	// 70 : 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(130));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 8, 4, 0, 0)), Pointee(Scheduler::Result(100u)));	//	80
...
TEST_F(TemperatureDependentSchedulerImplProcessTest, maxAdjustment) {
	...
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 1, 4, 0, 0)), Pointee(Scheduler::Result(75u)));	// 85 : 90
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(75));

	// remaining: 75 - 90 = -15
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 2, 4, 0, 0)), Pointee(Scheduler::Result(75u)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(60));

	// remaining: 60 - 75 = -15
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 3, 4, 0, 0)), Pointee(Scheduler::Result(75u)));	// 95 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(60));
	...
	// remaining: 25 - 50 = -25
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 5, 4, 0, 0)), Pointee(Scheduler::Result(75u)));	// 65 : 45
	...
	// remaining: 5 - 0 = 5
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 7, 4, 0, 0)), Pointee(Scheduler::Result(65u)));	// 70 : 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(70));

	// remaining: 70 - 70 = 0
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 8, 4, 0, 0)), Pointee(Scheduler::Result(75u)));	//	80
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(75));
}
...
TEST_F(TemperatureDependentSchedulerImplProcessTest, maxAdjustmentDailyTwoTimes) {
	...
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 1, 20, 0, 0)), Pointee(Scheduler::Result(10u)));	// 85 : 90
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(85));
	...
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 2, 20, 0, 0)), Pointee(Scheduler::Result(0u)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));
	...
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 3, 20, 0, 0)), Pointee(Scheduler::Result(30u)));	// 95 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(95));
	...
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 4, 20, 0, 0)), Pointee(Scheduler::Result(0u)));	// 60 : 50
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(60));
	...
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 5, 20, 0, 0)), Pointee(Scheduler::Result(0u)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));
	...
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 6, 20, 0, 0)), Pointee(Scheduler::Result(0u)));	// 0 : 0
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(20));
	...
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 7, 20, 0, 0)), Pointee(Scheduler::Result(0u)));	// 70 : 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(70));
	...
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 8, 20, 0, 0)), Pointee(Scheduler::Result(5u)));	//	80
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(80));
}
...
TEST_F(TemperatureDependentSchedulerImplProcessTest, minMaxAdjustment) {
	...
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 1, 16, 0, 0)), Pointee(Scheduler::Result(75u)));	// 85 : 90
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(150));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 2, 4, 0, 0)), Pointee(Scheduler::Result(75u)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(135));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 2, 16, 0, 0)), Pointee(Scheduler::Result(0u)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(135));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 3, 4, 0, 0)), Pointee(Scheduler::Result(75u))); 	// 95 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(135));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 3, 16, 0, 0)), Pointee(Scheduler::Result(0u))); 	// 95 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(135));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 4, 4, 0, 0)), Pointee(Scheduler::Result(75u)));	// 60 : 50
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 4, 16, 0, 0)), Pointee(Scheduler::Result(0u)));	// 60 : 50
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 5, 4, 0, 0)), Pointee(Scheduler::Result(75u)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(125));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 5, 16, 0, 0)), Pointee(Scheduler::Result(0u)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(125));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 6, 4, 0, 0)), Pointee(Scheduler::Result(0u)));	// 0 : 0
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(80));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 6, 16, 0, 0)), Pointee(Scheduler::Result(0u)));	// 0 : 0
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(80));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 7, 4, 0, 0)), Pointee(Scheduler::Result(0u)));	// 70 : 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(80));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 7, 16, 0, 0)), Pointee(Scheduler::Result(0u)));	// 70 : 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(80));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 8, 4, 0, 0)), Pointee(Scheduler::Result(75u)));	//	80
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(85));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 8, 16, 0, 0)), Pointee(Scheduler::Result(0u)));	//	80
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(85));
}
...
TEST_F(TemperatureDependentSchedulerImplProcessTest, remainingCorrection50) {
	...
	//	remaining: 85 - 90 = -5
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 2, 4, 0, 0)), Pointee(Scheduler::Result(67u)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));
	...
	//	remaining: 95 - 110 = -15
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 4, 4, 0, 0)), Pointee(Scheduler::Result(67u)));	// 60 : 50
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(60));

	//	remaining: 60 - 50 = 10
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 5, 4, 0, 0)), Pointee(Scheduler::Result(60u)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));
...
TEST_F(TemperatureDependentSchedulerImplProcessTest, remainingCorrection0) {
	...
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 2, 4, 0, 0)), Pointee(Scheduler::Result(65u)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 3, 4, 0, 0)), Pointee(Scheduler::Result(95u)));	// 95 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(95));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 4, 4, 0, 0)), Pointee(Scheduler::Result(60u)));	// 60 : 50
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(60));

	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 5, 4, 0, 0)), Pointee(Scheduler::Result(65u)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));
...
TEST_F(TemperatureDependentSchedulerImplProcessTest, minAdjustmentAndRemainingCorrection50) {
	...
	//	remaining: 102 - 50 = 52
	EXPECT_THAT(scheduler->process(LocalDateTime(2019, 8, 5, 4, 0, 0)), Pointee(Scheduler::Result(100u)));	// 65 : 45
