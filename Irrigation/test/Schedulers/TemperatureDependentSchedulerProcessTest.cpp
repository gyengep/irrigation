...
void TemperatureDependentSchedulerProcessTest::SetUp() {
	...
	EXPECT_CALL(*mockTemperatureForecast, getTemperatureForecast(LocalDateTime::create(2019, 8, 7, 4, 0, 0), LocalDateTime::create(2019, 8, 8, 3, 59, 59))).
		WillOnce(Return(TemperatureForecast::Values(0, 29.0f)));
	EXPECT_CALL(*mockTemperatureForecast, getTemperatureForecast(LocalDateTime::create(2019, 8, 8, 4, 0, 0), LocalDateTime::create(2019, 8, 9, 3, 59, 59))).
	...
	EXPECT_CALL(*mockTemperatureHistory, getTemperatureHistory(LocalDateTime::create(2019, 8, 6, 4, 0, 0), LocalDateTime::create(2019, 8, 7, 3, 59, 59))).
		WillOnce(Return(TemperatureHistory::Values(0, 10.0f, 0)));
	EXPECT_CALL(*mockTemperatureHistory, getTemperatureHistory(LocalDateTime::create(2019, 8, 7, 4, 0, 0), LocalDateTime::create(2019, 8, 8, 3, 59, 59))).
...
TEST_F(TemperatureDependentSchedulerProcessTest, process) {
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 70)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 3, 4, 0, 0)), Eq(Scheduler::Result(true, true, 105)));	// 95 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(95));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 4, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75)));	// 60 : 50
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(60));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 5, 4, 0, 0)), Eq(Scheduler::Result(true, true, 55)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 6, 4, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	// 0 : 0
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(20));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 7, 4, 0, 0)), Eq(Scheduler::Result(true, true, 50)));	// 70 : 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(70));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 8, 4, 0, 0)), Eq(Scheduler::Result(true, true, 80)));	//	80
...
TEST_F(TemperatureDependentSchedulerProcessTest, minAdjustment70) {
	...
	// remaining: 60 - 50 = 10
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 5, 4, 0, 0)), Eq(Scheduler::Result(true, true, 70)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(80));
	...
	// remaining: 35 - 0 = 35
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 7, 4, 0, 0)), Eq(Scheduler::Result(true, true, 70)));	// 70 : 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(105));

	// remaining: 105 - 70 = 35
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 8, 4, 0, 0)), Eq(Scheduler::Result(true, true, 70)));	//	80
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(105));
}
...
TEST_F(TemperatureDependentSchedulerProcessTest, minAdjustment100) {
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(110));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 3, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100))); 	// 95 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(135));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 4, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 60 : 50
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(125));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 5, 4, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(75));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 6, 4, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	// 0 : 0
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(30));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 7, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 70 : 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(130));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 8, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	//	80
...
TEST_F(TemperatureDependentSchedulerProcessTest, maxAdjustment) {
	...
	// remaining: 75 - 90 = -15
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(60));

	// remaining: 60 - 75 = -15
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 3, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75)));	// 95 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(60));
	...
	// remaining: 25 - 50 = -25
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 5, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75)));	// 65 : 45
	...
	// remaining: 5 - 0 = 5
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 7, 4, 0, 0)), Eq(Scheduler::Result(true, true, 65)));	// 70 : 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(70));

	// remaining: 70 - 70 = 0
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 8, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75)));	//	80
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(75));
}
...
TEST_F(TemperatureDependentSchedulerProcessTest, maxAdjustmentDailyTwoTimes) {
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 1, 20, 0, 0)), Eq(Scheduler::Result(true, true, 10)));	// 85 : 90
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(85));
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 20, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 3, 20, 0, 0)), Eq(Scheduler::Result(true, true, 30)));	// 95 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(95));
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 4, 20, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	// 60 : 50
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(60));
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 5, 20, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 6, 20, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	// 0 : 0
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(20));
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 7, 20, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	// 70 : 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(70));
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 8, 20, 0, 0)), Eq(Scheduler::Result(true, true, 5)));	//	80
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(80));
}
...
TEST_F(TemperatureDependentSchedulerProcessTest, minMaxAdjustment) {
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 1, 16, 0, 0)), Eq(Scheduler::Result(true, true, 75)));	// 85 : 90
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(150));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(135));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 16, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(135));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 3, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75))); 	// 95 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(135));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 3, 16, 0, 0)), Eq(Scheduler::Result(false, true, 0))); 	// 95 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(135));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 4, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75)));	// 60 : 50
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 4, 16, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	// 60 : 50
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 5, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(125));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 5, 16, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(125));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 6, 4, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	// 0 : 0
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(80));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 6, 16, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	// 0 : 0
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(80));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 7, 4, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	// 70 : 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(80));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 7, 16, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	// 70 : 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(80));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 8, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75)));	//	80
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(85));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 8, 16, 0, 0)), Eq(Scheduler::Result(false, true, 0)));	//	80
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(85));
}
...
TEST_F(TemperatureDependentSchedulerProcessTest, remainingCorrection50) {
	...
	//	remaining: 85 - 90 = -5
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 67)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));
	...
	//	remaining: 95 - 110 = -15
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 4, 4, 0, 0)), Eq(Scheduler::Result(true, true, 67)));	// 60 : 50
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(60));

	//	remaining: 60 - 50 = 10
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 5, 4, 0, 0)), Eq(Scheduler::Result(true, true, 60)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));
...
TEST_F(TemperatureDependentSchedulerProcessTest, remainingCorrection0) {
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 65)));	// 65 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 3, 4, 0, 0)), Eq(Scheduler::Result(true, true, 95)));	// 95 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(95));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 4, 4, 0, 0)), Eq(Scheduler::Result(true, true, 60)));	// 60 : 50
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(60));

	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 5, 4, 0, 0)), Eq(Scheduler::Result(true, true, 65)));	// 65 : 45
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(65));
...
TEST_F(TemperatureDependentSchedulerProcessTest, trim) {
	...
	// remaining: 65 - 75 = -10
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 3, 4, 0, 0)), Eq(Scheduler::Result(true, true, 90)));	// 95 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(80));
...
TEST_F(TemperatureDependentSchedulerProcessTest, minAdjustmentAndRemainingCorrection50) {
	...
	//	remaining: 102 - 50 = 52
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 5, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 65 : 45
