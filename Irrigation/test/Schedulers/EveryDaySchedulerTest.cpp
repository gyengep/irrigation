...
TEST(EveryDaySchedulerTest, isDayScheduled) {
	...
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 7)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 8)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 9)), Eq(Scheduler::Result(true, false, 0)));
	...
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 15)), Eq(Scheduler::Result(true, false, 0)));
	...
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 21)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 22)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 23)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 24)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2018, 11, 25)), Eq(Scheduler::Result(true, false, 0)));

	///////////////////////////////////////////////////////////////////////////

	EXPECT_THAT(scheduler.process(fromLocalTime(2017, 11, 13)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2017, 11, 14)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2017, 11, 15)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2017, 11, 16)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2017, 11, 17)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2017, 11, 18)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2017, 11, 19)), Eq(Scheduler::Result(true, false, 0)));

	///////////////////////////////////////////////////////////////////////////

	EXPECT_THAT(scheduler.process(fromLocalTime(2016, 11, 14)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2016, 11, 15)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2016, 11, 16)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2016, 11, 17)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2016, 11, 18)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2016, 11, 19)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler.process(fromLocalTime(2016, 11, 20)), Eq(Scheduler::Result(true, false, 0)));
}
