...
TEST_F(HotWeatherSchedulerTest, process) {
	...
	EXPECT_THAT(scheduler->process(toLocalTime(2019, 8, 7, 14, 0, 0)), Eq(Scheduler::Result(true, false, 0)));
}
...
TEST_F(HotWeatherSchedulerTest, processLowTemp) {
	...
	EXPECT_THAT(scheduler->process(toLocalTime(2019, 8, 7, 14, 0, 0)), Eq(Scheduler::Result(false, false, 0)));
}

TEST_F(HotWeatherSchedulerTest, period1Hours) {
	scheduler->setPeriod(chrono::hours(1));

	EXPECT_CALL(*mockTemperatureHistory, getHistoryValues(toLocalTime(2019, 8, 7, 13, 0, 0), toLocalTime(2019, 8, 7, 14, 0, 0))).
		WillOnce(Return(TemperatureHistory::Values(20, 30, 26)));

	scheduler->process(toLocalTime(2019, 8, 7, 14, 0, 0));
}

TEST_F(HotWeatherSchedulerTest, period3Hours) {
	scheduler->setPeriod(chrono::hours(3));

	EXPECT_CALL(*mockTemperatureHistory, getHistoryValues(toLocalTime(2019, 8, 7, 11, 0, 0), toLocalTime(2019, 8, 7, 14, 0, 0))).
		WillOnce(Return(TemperatureHistory::Values(20, 30, 26)));
...
TEST_F(HotWeatherSchedulerTest, lastRun1Hour) {
	...
	EXPECT_CALL(*mockTemperatureHistory, getHistoryValues(toLocalTime(2019, 8, 7, 13, 0, 0), toLocalTime(2019, 8, 7, 14, 0, 0))).
		WillOnce(Return(TemperatureHistory::Values(20, 30, 26)));
	EXPECT_CALL(*mockTemperatureHistory, getHistoryValues(toLocalTime(2019, 8, 7, 14, 0, 0), toLocalTime(2019, 8, 7, 15, 0, 0))).
		WillOnce(Return(TemperatureHistory::Values(20, 30, 27)));
	EXPECT_CALL(*mockTemperatureHistory, getHistoryValues(toLocalTime(2019, 8, 7, 15, 0, 0), toLocalTime(2019, 8, 7, 16, 0, 0))).
		WillOnce(Return(TemperatureHistory::Values(20, 30, 28)));

	EXPECT_THAT(scheduler->process(toLocalTime(2019, 8, 7, 14, 0, 0)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler->process(toLocalTime(2019, 8, 7, 15, 0, 0)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler->process(toLocalTime(2019, 8, 7, 16, 0, 0)), Eq(Scheduler::Result(true, false, 0)));
}
...
TEST_F(HotWeatherSchedulerTest, lastRun2Hour) {
	...
	EXPECT_THAT(scheduler->process(toLocalTime(2019, 8, 7, 14, 0, 0)), Eq(Scheduler::Result(true, false, 0)));
	EXPECT_THAT(scheduler->process(toLocalTime(2019, 8, 7, 15, 0, 0)), Eq(Scheduler::Result(false, false, 0)));
	EXPECT_THAT(scheduler->process(toLocalTime(2019, 8, 7, 16, 0, 0)), Eq(Scheduler::Result(true, false, 0)));
}
