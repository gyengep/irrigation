...
TEST_F(TemperatureDependentSchedulerTest, getAdjustmentToday) {
	EXPECT_CALL(*mockTemperatureForecast, getForecastValues(fromLocalTime(2020, 2, 15, 4, 0, 0), fromLocalTime(2020, 2, 16, 3, 59, 59))).
		WillOnce(Return(TemperatureForecast::Values(0, 25)));

	EXPECT_THAT(scheduler->process(fromLocalTime(2020, 2, 15, 4, 0, 0)), Eq(Scheduler::Result(true, true, 50)));
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(50));

	EXPECT_THAT(scheduler->process(fromLocalTime(2020, 2, 15, 14, 0, 0)), Eq(Scheduler::Result(false, true, 0)));
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(50));
}
...
TEST_F(TemperatureDependentSchedulerTest, getAdjustmentYesterdayDay) {
	EXPECT_CALL(*mockTemperatureForecast, getForecastValues(fromLocalTime(2020, 2, 15, 4, 0, 0), fromLocalTime(2020, 2, 16, 3, 59, 59))).
		WillOnce(Return(TemperatureForecast::Values(0, 25)));
	EXPECT_CALL(*mockTemperatureHistory, getHistoryValues(fromLocalTime(2020, 2, 15, 4, 0, 0), fromLocalTime(2020, 2, 16, 3, 59, 59))).
		WillOnce(Return(TemperatureHistory::Values(0, 25, 0)));
	EXPECT_CALL(*mockTemperatureForecast, getForecastValues(fromLocalTime(2020, 2, 16, 4, 0, 0), fromLocalTime(2020, 2, 17, 3, 59, 59))).
		WillOnce(Return(TemperatureForecast::Values(0, 30)));

	EXPECT_THAT(scheduler->process(fromLocalTime(2020, 2, 15, 4, 0, 0)), Eq(Scheduler::Result(true, true, 50)));
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(50));

	EXPECT_THAT(scheduler->process(fromLocalTime(2020, 2, 16, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75)));
...
TEST_F(TemperatureDependentSchedulerTest, getAdjustmentOtherDay) {
	EXPECT_CALL(*mockTemperatureForecast, getForecastValues(fromLocalTime(2020, 2, 15, 4, 0, 0), fromLocalTime(2020, 2, 16, 3, 59, 59))).
		WillOnce(Return(TemperatureForecast::Values(0, 25)));
	EXPECT_CALL(*mockTemperatureForecast, getForecastValues(fromLocalTime(2020, 2, 17, 4, 0, 0), fromLocalTime(2020, 2, 18, 3, 59, 59))).
		WillOnce(Return(TemperatureForecast::Values(0, 30)));

	EXPECT_THAT(scheduler->process(fromLocalTime(2020, 2, 15, 4, 0, 0)), Eq(Scheduler::Result(true, true, 50)));
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(50));

	EXPECT_THAT(scheduler->process(fromLocalTime(2020, 2, 17, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75)));
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(75));
}
...
TEST_F(TemperatureDependentSchedulerTest, dayStart) {
	EXPECT_CALL(*mockTemperatureForecast, getForecastValues(fromLocalTime(2020, 2, 28, 0, 0, 0), fromLocalTime(2020, 2, 28, 23, 59, 59))).
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2020, 2, 28, 23, 59, 59)), Eq(Scheduler::Result(false, true, 0)));
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(25));
}
...
TEST_F(TemperatureDependentSchedulerTest, trim1) {
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 1, 4, 0, 0)), Eq(Scheduler::Result(true, true, 70)));	// 70 : 90
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(70));

	// remaining: 70 - 90 = -20
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 90)));	// 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(70));
}
...
TEST_F(TemperatureDependentSchedulerTest, trim2) {
	...
	// remaining: 70 - 90 = -20
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 110)));	// 90
...
TEST_F(TemperatureDependentSchedulerTest, trim3) {
	...
	// remaining: 70 - 90 = -20
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 120)));	// 110
...
TEST_F(TemperatureDependentSchedulerTest, trim4) {
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 1, 4, 0, 0)), Eq(Scheduler::Result(true, true, 90)));	// 90 : 70
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(90));

	// remaining: 90 - 70 = 20
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 70)));	// 90
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(90));
}
...
TEST_F(TemperatureDependentSchedulerTest, trim5) {
	...
	// remaining: 90 - 70 = 20
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 80)));	// 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));
}
...
TEST_F(TemperatureDependentSchedulerTest, trim6) {
	...
	// remaining: 90 - 70 = 20
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 80)));	// 130
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));
}
...
TEST_F(TemperatureDependentSchedulerTest, trim7) {
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 1, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 105 : 115
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));

	// remaining: 100 - 100 = 0
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 110 : 115
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));

	// remaining: 100 - 100 = 0
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 3, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 110 : 100
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));

	// remaining: 100 - 100 = 0
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 4, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 105 : 110
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));

	// remaining: 100 - 100 = 0
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 5, 4, 0, 0)), Eq(Scheduler::Result(true, true, 95)));	// 95 : 40
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(95));

	// remaining: 95 - 40 = 55
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 6, 4, 0, 0)), Eq(Scheduler::Result(true, true, 20)));	// 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(75));
}
...
TEST_F(TemperatureDependentSchedulerTest, trim8) {
	...
	// remaining: 100 - 100 = 0
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 105 : 115
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));

	// remaining: 100 - 100 = 0
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 3, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 105
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));
}
...
TEST_F(TemperatureDependentSchedulerTest, trim9) {
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 1, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 115 : 105
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));

	// remaining: 100 - 100 = 0
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 115 : 105
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));

	// remaining: 100 - 100 = 0
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 3, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 115
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));
}
...
TEST_F(TemperatureDependentSchedulerTest, trim11) {
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 1, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75)));	// 75 : 115
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(75));

	// remaining: 75 - 100 = -25
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 75 : 115
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(75));

	// remaining: 75 - 100 = -25
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 3, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(75));
}
...
TEST_F(TemperatureDependentSchedulerTest, trim12) {
	...
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 1, 4, 0, 0)), Eq(Scheduler::Result(true, true, 100)));	// 115 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));

	// remaining: 100 - 75 = 25
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 2, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75)));	// 115 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));

	// remaining: 100 - 75 = 25
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 3, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75)));	// 115 : 75
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));

	// remaining: 100 - 75 = 25
	EXPECT_THAT(scheduler->process(fromLocalTime(2019, 8, 4, 4, 0, 0)), Eq(Scheduler::Result(true, true, 75)));	// 115
	EXPECT_THAT(scheduler->getRemainingPercent(), Eq(100));
}
