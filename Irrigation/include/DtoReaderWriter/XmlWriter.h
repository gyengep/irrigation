...
public:
	...
	virtual std::string save(const ProgramDTO& program, bool includeContainers = true) override;
	...
	virtual std::string save(const std::list<ProgramDTO>& programs, bool includeContainers = true) override;
